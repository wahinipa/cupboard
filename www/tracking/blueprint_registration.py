...
def blueprint_registeration(target_application):
    ...
    target_application.register_blueprint(group_bp, url_prefix=HOME_PREFIX)

    from www.tracking.people.people_routes import people_bp
    target_application.register_blueprint(people_bp, url_prefix=HOME_PREFIX)

    from www.tracking.places.place_routes import places_bp
    target_application.register_blueprint(places_bp, url_prefix=HOME_PREFIX)

    from www.tracking.things.thing_routes import things_bp
    target_application.register_blueprint(things_bp, url_prefix=HOME_PREFIX)
