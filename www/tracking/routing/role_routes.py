...
from tracking.page_handlers.link_handler import LinkHandler
...
from tracking.page_handlers.unlink_handler import UnlinkHandler
...
@role_bp.route('/link/<int:place_id>/<int:person_id>')
@login_required
def role_link(place_id, person_id):
    return LinkHandler('role_bp.role_link', current_user, place_id=place_id, person_id=person_id).handle()

@role_bp.route('/unlink/<int:place_id>/<int:person_id>')
@login_required
def role_unlink(place_id, person_id):
    return UnlinkHandler('role_bp.role_unlink', current_user, place_id=place_id, person_id=person_id).handle()
