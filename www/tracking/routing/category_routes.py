...
@category_bp.route('/delete/<int:category_id>/<int:place_id>/<int:particular_thing_id>')
@login_required
def category_delete(category_id, place_id, particular_thing_id):
    ...
    if category and place and particular_thing and place.root == category.root \
        and particular_thing.root == category.root and category.may_delete(current_user):
...
@category_bp.route('/view/<int:category_id>/<int:place_id>/<int:particular_thing_id>')
@login_required
def category_view(category_id, place_id, particular_thing_id):
    category = find_category_by_id(category_id)
    place = find_place_by_id(place_id)
    particular_thing = find_particular_thing_by_id(particular_thing_id)
    if category and place and particular_thing and place.root == category.root \
        and particular_thing.root == category.root and category.may_be_observed(current_user):
        navigator = DualNavigator(place=place, particular_thing=particular_thing)
        display_attributes = {
            'description': True,
            'children': [category, particular_thing],
            'children_attributes': dual_view_childrens_attributes(thing=particular_thing.thing),
        }
...
@category_bp.route('/update/<int:category_id>/<int:place_id>/<int:particular_thing_id>', methods=['GET', 'POST'])
@login_required
def category_update(category_id, place_id, particular_thing_id):
    category = find_category_by_id(category_id)
    place = find_place_by_id(place_id)
    particular_thing = find_particular_thing_by_id(particular_thing_id)
    if category and place and particular_thing and place.root == category.root \
...
@category_bp.route('/create/<int:category_id>/<int:place_id>/<int:particular_thing_id>', methods=['POST', 'GET'])
@login_required
def category_create(category_id, place_id, particular_thing_id):
    category = find_category_by_id(category_id)
    place = find_place_by_id(place_id)
    particular_thing = find_particular_thing_by_id(particular_thing_id)
    if category and place and particular_thing and place.root == category.root \
        and particular_thing.root == category.root and category.may_create_choice(current_user):
