...
@category_bp.route('/delete/<int:category_id>/<activity>/<int:place_id>/<int:thing_id>/<int:specification_id>')
@login_required
def category_delete(**kwargs):
    return CategoryDeleteHandler(current_user, **kwargs).handle()


@category_bp.route('/view/<int:category_id>/<activity>/<int:place_id>/<int:thing_id>/<int:specification_id>')
@login_required
def category_view(**kwargs):
    return CategoryViewHandler(current_user, **kwargs).handle()


@category_bp.route('/update/<int:category_id>/<activity>/<int:place_id>/<int:thing_id>/<int:specification_id>',
                   methods=['GET', 'POST'])
@login_required
...
@category_bp.route('/create/<int:category_id>/<activity>/<int:place_id>/<int:thing_id>/<int:specification_id>',
                   methods=['POST', 'GET'])
@login_required
