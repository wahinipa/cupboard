...
@refinement_bp.route('/add/<activity>/<int:place_id>/<int:thing_id>/<int:specification_id>/<int:category_id>',
                     methods=['POST', 'GET'])
@login_required
...
@refinement_bp.route('/remove/<activity>/<int:place_id>/<int:thing_id>/<int:specification_id>/<int:category_id>',
                     methods=['POST', 'GET'])
@login_required
