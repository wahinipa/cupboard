...
def inventory_arriving(place_id, thing_id, specification_id):
    handler = InventoryArrivalHandler(current_user, place_id, thing_id, specification_id)
...
def inventory_departing(thing_id, place_id, specification_id):
    handler = InventoryDepartureHandler(current_user, place_id, thing_id, specification_id)
    return handler.render() or home_redirect()
