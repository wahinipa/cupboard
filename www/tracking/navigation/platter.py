...
class Platter:
    ...
    def choice_url_maker(self, choice, task, activity=None):
        return self.valid_url_for(f'choice_bp.choice_{task}', choice_id=choice.id, activity=activity, place_id=self.place_id,
                       destination_id=self.destination_id,
                       thing_id=self.thing_id, specification_id=self.specification_id)
    ...
    def place_url_maker(self, place, task, activity=None):
        ...
        return self.valid_url_for(f'place_bp.place_{task}', activity=activity, place_id=place.id, thing_id=self.thing_id,
                       destination_id=self.destination_id,
    ...
    def specification_url_maker(self, category_specification, task, activity=None):
        ...
        return self.valid_url_for(f'specification_bp.specification_update', category_id=category_specification.category.id,
    ...
    def thing_url_maker(self, thing, task, activity=None):
        ...
        return self.valid_url_for(f'thing_bp.thing_{task}', activity=activity, place_id=self.place_id, thing_id=self.thing_id,
                       destination_id=self.destination_id,
                       specification_id=self.specification_id)
