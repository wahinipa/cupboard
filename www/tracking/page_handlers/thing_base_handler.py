...
class ThingBaseHandler(PageHandler, PlatterHoldingHandler, TargetHandler):
    ...
    def __init__(self, viewer, **kwargs):
        ...
        TargetHandler.__init__(self, self.thing)  # Depends on PlatterHoldingHandler to have created self.thing
