...
class InventoryDepartureHandler(InventoryBaseHandler):
    ...
    def create_form(self):
        return create_departure_form(self.placement)

    @property
    def form_title(self):
        return f'Remove departing {self.description} from {self.placement.place.name}'

    def submit_action(self):
        return remove_quantity_from_form(self.placement, self.form)
