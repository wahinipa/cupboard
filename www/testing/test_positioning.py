...
def test_quantities(rainbow_place, wild_place, light_saber, knights_of_the_round_table, muffin, roll):
    ...
    assert find_quantity_of_things(rainbow_place, muffin_light_saber) == 0

    assert add_quantity_of_things(rainbow_place, muffin_light_saber, 3) == 3
    assert find_quantity_of_things(rainbow_place, muffin_light_saber) == 3

    assert add_quantity_of_things(rainbow_place, muffin_light_saber, 4) == 7
    assert find_quantity_of_things(rainbow_place, muffin_light_saber) == 7

    assert add_quantity_of_things(rainbow_place, muffin_light_saber, -2) == 5
    assert find_quantity_of_things(rainbow_place, muffin_light_saber) == 5
    ...
    assert find_quantity_of_things(rainbow_place, muffin_light_saber) == 15
    assert muffin_light_saber.add_to_place(rainbow_place, 9) == 24
    assert find_quantity_of_things(rainbow_place, muffin_light_saber) == 24
